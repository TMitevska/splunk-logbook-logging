...
public interface CustomStructuredHttpLogFormatter extends HttpLogFormatter {
    ...
    default String format(final Correlation correlation, final HttpRequest request, final HttpResponse response)
            throws IOException {
    ...
    default Map<String, Object> prepare(final Correlation correlation, final HttpRequest request, final HttpResponse response)
            throws IOException {
